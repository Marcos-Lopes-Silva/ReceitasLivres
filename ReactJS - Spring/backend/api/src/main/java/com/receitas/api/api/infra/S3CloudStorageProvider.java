package com.receitas.api.api.infra;
...
import com.receitas.api.api.domain.services.CloudStorageProvider;
import com.receitas.api.api.infra.core.exception.StorageCloudException;
...
public class S3CloudStorageProvider implements CloudStorageProvider {
    ...
    public URL generatedUploadUrl(FileReference fileReference) {
        ...
        PutObjectPresignRequest presignRequest = PutObjectPresignRequest.builder()
                ...
                .build();
        System.out.println((s3Presigner.presignPutObject(presignRequest)).url());
        return s3Presigner.presignPutObject(presignRequest).url();
    }

    public URL generatedDownloadUrl(FileReference fileReference) {
    ...
    private String getBucket() {
        return storageProvider.getS3().getBucket();
    }
}