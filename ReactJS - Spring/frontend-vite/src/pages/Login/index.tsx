import { CgLock, CgLockUnlock, CgMail } from 'react-icons/cg';
    ...
    <div className={styles.section}>
      <div className={styles.section__formbox}>
        <form onSubmit={handleLogin} >
          ...
          {
            typePass == 'password'
            ? <CgLock className={styles.section__icon} size={20} color="#4C4D5E" onClick={() => setTypePass('text')} style={{cursor: 'pointer'}}/> 
            : <CgLockUnlock className={styles.section__icon} size={20} color="#4C4D5E" onClick={() => setTypePass('password')} style={{cursor: 'pointer'}} />
          }
